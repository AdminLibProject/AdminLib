...
using DjangoSharp.Field;

namespace DjangoSharp.Query {
    ...
    public class SqlQuery {
        ...
        private class OrderByElement : IComparable<OrderByElement> {
            ...
            public DjangoSharp.OrderByDirection orderBy     {get; private set; }
            public SelectColumn        column      {get; private set; }

            public OrderByElement(Path fieldPath, SelectColumn column) {
                this.orderBy     = fieldPath.orderBy ?? DjangoSharp.OrderByDirection.asc;
            ...
            public override string ToString() {
                return this.column.ToString(false) + ' ' + (this.orderBy == DjangoSharp.OrderByDirection.asc ? "ASC" : "DESC");
            }
